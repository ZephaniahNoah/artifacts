...
public class ModAbilities {
    ...
    public static final RegistrySupplier<Type<ReduceEatingDurationAbility>> REDUCE_EATING_DURATION = register("reduce_eating_duration", ReduceEatingDurationAbility.CODEC, ReduceEatingDurationAbility.STREAM_CODEC);
